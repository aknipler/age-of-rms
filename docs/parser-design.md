...
| RMS0304 | warning | Wrong-section placement — **still unbuilt, but now unblocked** (measured 2026-08-04). Must be driven by a per-command `sectionLocked` flag, never by `CommandDef.section`; see below |
