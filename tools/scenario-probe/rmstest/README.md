...
`RMSTEST_20` onward are the calibration batch below, written and not yet run.
...
## Batch 2 (NOT YET RUN) — everything else that needs the game
...
## Batch 3 (NOT YET RUN) — three re-tests, written 2026-08-04
...
## Batch 4 (NOT YET RUN) — one script, written 2026-08-04
...
## Batch 5 (NOT YET RUN) — the land-growth sweep, written 2026-08-04
...
## Batch 6 (NOT YET RUN) — item 11(a), written 2026-08-04
...
## Batch 7 (NOT YET RUN) — elevation GROWTH bias, written 2026-08-04
...
## Batch 8 (NOT YET RUN) — elevation bias vs clump density, written 2026-08-04
